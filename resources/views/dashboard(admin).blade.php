...
<div
    ...
    <h1 class="text-base sm:text-lg font-semibold dark:text-gray-400 mt-2">Jumlah Anak Magang/PKL</h1>
    ...
    <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-2"></p>
...
<div
    class="relative overflow-hidden rounded-xl border-l-8 border-blue-500 border border-neutral-200 dark:border-neutral-700
           ...
           shadow-md hover:shadow-xl transition-shadow duration-200
           aspect-[16/9] sm:aspect-video">
    <h1 class="text-base sm:text-lg font-semibold dark:text-gray-400 mt-2">Jumlah Mentor Vodeco</h1>
     <svg xmlns="http://www.w3.org/2000/svg"
...
<div
    class="relative overflow-hidden rounded-xl border-l-8 border-blue-500 border border-neutral-200 dark:border-neutral-700
           ...
           shadow-md hover:shadow-xl transition-shadow duration-200
           aspect-[16/9] sm:aspect-video">
    <h1 class="text-base sm:text-lg font-semibold dark:text-gray-400 mt-2">Progress</h1>
    <svg xmlns="http://www.w3.org/2000/svg"
         class="absolute top-7 right-7 w-[60px] h-[60px]
                text-black dark:text-gray-300
                opacity-80"
