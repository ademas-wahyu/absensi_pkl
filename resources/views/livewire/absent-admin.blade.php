<div>
    <div class="mb-4 flex items-center justify-between">
        ...
        <div class="flex items-center">
            <flux:modal.trigger name="input-absent-admin">
<flux:button
    class="
...
<livewire:absent-admin-input />
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm text-left text-neutral-700 dark:text-neutral-300">
            ...
            <tbody>
                @foreach($absentAdmin as $absentAdmin)
                    <tr class="even:bg-neutral-50 dark:even:bg-neutral-700">
                        <td class="border border-neutral-300 px-4 py-2 dark:border-neutral-700">{{ $absentAdmin->name }}</td>
                        <td class="border border-neutral-300 px-4 py-2 dark:border-neutral-700">{{ $absentAdmin->absent_date }}</td>
                        <td class="border border-neutral-300 px-4 py-2 dark:border-neutral-700">{{ $absentAdmin->divisi }}</td>
                        <td class="border border-neutral-300 px-4 py-2 dark:border-neutral-700">{{ $absentAdmin->status }}</td>
                        <td class="border border-neutral-300 px-4 py-2 dark:border-neutral-700">{{ $absentAdmin->reason }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
