        ...
        <div class="p-6">
            ...
            <form wire:submit="save" class="space-y-4">
                ...
                <div>
                    ...
                    <select wire:model.live="divisi" class="w-full px-3 py-2 rounded-lg border border-neutral-300 dark:border-neutral-600 
                        bg-white dark:bg-neutral-700 text-neutral-800 dark:text-neutral-200
                        focus:ring-2 focus:ring-[#3526B3] dark:focus:ring-[#8615D9] focus:border-transparent">
                        <option value="">Pilih Divisi</option>
                        @foreach($divisiOptions as $divisiOpt)
                            <option value="{{ $divisiOpt->nama_divisi }}">{{ $divisiOpt->nama_divisi }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select wire:model="sekolah" class="w-full px-3 py-2 rounded-lg border border-neutral-300 dark:border-neutral-600 
                        ...
                        @foreach($sekolahList as $sekolahOpt)
                            <option value="{{ $sekolahOpt }}">{{ $sekolahOpt }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <div class="relative">
                        <select wire:model="mentor_id"
                            ...
                            bg-white dark:bg-neutral-700 text-neutral-800 dark:text-neutral-200
                            focus:ring-2 focus:ring-[#3526B3] dark:focus:ring-[#8615D9] focus:border-transparent cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                            {{ empty($divisi) ? 'disabled' : '' }}>
                            ...
                            @else
                                ...
                                @empty
                                    <option value="" disabled>Tidak ada mentor aktif di divisi ini</option>
                                @endforelse
                            @endif
                        </select>
                        <div wire:loading wire:target="divisi" class="absolute right-3 top-1/2 -translate-y-1/2">
                            <svg class="animate-spin h-4 w-4 text-[#3526B3] dark:text-[#8615D9]"
