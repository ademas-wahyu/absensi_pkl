<div>
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h2 class="text-xl font-semibold text-neutral-800 dark:text-neutral-200">
                Total Anak PKL Non-Aktif (Arsip): <span
                    class="text-[#3526B3] dark:text-[#8615D9]">{{ $students->total() }}</span>
            </h2>
        </div>
    </div>
    ...
    <div
        ...
        <table class="w-full text-sm text-left text-neutral-700 dark:text-neutral-300 relative">
            <div wire:loading.flex wire:target="search, gotoPage, previousPage, nextPage"
