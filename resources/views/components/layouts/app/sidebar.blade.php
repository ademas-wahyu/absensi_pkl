...
<body class="h-fit-screen w-full overflow-x-hidden bg-slate-50 dark:bg-zinc-900 antialiased">
    ...
    <flux:sidebar sticky collapsible class="h-screen sticky top-0 bg-white text-zinc-700 border-r border-zinc-200 shadow-sm
        ...
        <flux:sidebar.nav>
            ...
            <flux:sidebar.item icon="user" :href="route('mentor_admin')" :current="request()->routeIs('mentor_admin')"
                wire:navigate class="{{ $navItemClasses }}">
                {{ __('Daftar Mentor') }}
            </flux:sidebar.item>
            ...
            {{-- Divisi untuk Murid --}}
            @role('murid')
            <flux:sidebar.item icon="id-card" :href="route('divisi')" :current="request()->routeIs('divisi')"
                wire:navigate class="{{ $navItemClasses }}">
                {{ __('Divisi') }}
            </flux:sidebar.item>
            @endrole
